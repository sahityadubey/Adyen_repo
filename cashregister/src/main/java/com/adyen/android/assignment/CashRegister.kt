...
class CashRegister(private val change: Change) {
    ...
    private fun calculateChange(cashDiff: Long): Change {
        ...
        while (cashBack > 0) {
            when {
                //Euro
                cashBack >= Bill.FIVE_HUNDRED_EURO.minorValue && change.getCount(Bill.FIVE_HUNDRED_EURO) > 0 -> moneyType =
                    Bill.FIVE_HUNDRED_EURO
                cashBack >= Bill.TWO_HUNDRED_EURO.minorValue && change.getCount(Bill.TWO_HUNDRED_EURO) > 0 -> moneyType =
                    Bill.TWO_HUNDRED_EURO
                cashBack >= Bill.ONE_HUNDRED_EURO.minorValue && change.getCount(Bill.ONE_HUNDRED_EURO) > 0 -> moneyType =
                    Bill.ONE_HUNDRED_EURO
                cashBack >= Bill.FIFTY_EURO.minorValue && change.getCount(Bill.FIFTY_EURO) > 0 -> moneyType =
                    Bill.FIFTY_EURO
                cashBack >= Bill.TWENTY_EURO.minorValue && change.getCount(Bill.TWENTY_EURO) > 0 -> moneyType =
                    Bill.TWENTY_EURO
                cashBack >= Bill.TEN_EURO.minorValue && change.getCount(Bill.TEN_EURO) > 0 -> moneyType =
                    Bill.TEN_EURO
                cashBack >= Bill.FIVE_EURO.minorValue && change.getCount(Bill.FIVE_EURO) > 0 -> moneyType =
                    Bill.FIVE_EURO
                cashBack >= Coin.TWO_EURO.minorValue && change.getCount(Coin.TWO_EURO) > 0 -> moneyType =
                    Coin.TWO_EURO
                cashBack >= Coin.ONE_EURO.minorValue && change.getCount(Coin.ONE_EURO) > 0 -> moneyType =
                    Coin.ONE_EURO

                //Cents
                cashBack >= Coin.FIFTY_CENT.minorValue && change.getCount(Coin.FIFTY_CENT) > 0 -> moneyType =
                    Coin.FIFTY_CENT
                cashBack >= Coin.TWENTY_CENT.minorValue && change.getCount(Coin.TWENTY_CENT) > 0 -> moneyType =
                    Coin.TWENTY_CENT
                cashBack >= Coin.TEN_CENT.minorValue && change.getCount(Coin.TEN_CENT) > 0 -> moneyType =
                    Coin.TEN_CENT
                cashBack >= Coin.FIVE_CENT.minorValue && change.getCount(Coin.FIVE_CENT) > 0 -> moneyType =
                    Coin.FIVE_CENT
                cashBack >= Coin.TWO_CENT.minorValue && change.getCount(Coin.TWO_CENT) > 0 -> moneyType =
                    Coin.TWO_CENT
                cashBack >= Coin.ONE_CENT.minorValue && change.getCount(Coin.ONE_CENT) > 0 -> moneyType =
                    Coin.ONE_CENT
